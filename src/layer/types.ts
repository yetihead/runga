export type RenderFunctionResult<Data extends object> = void|Partial<Data>|Promise<Partial<Data>>;
...
export type RenderFunction<Data extends object> = (params: RenderFunctionParams<Data>) => RenderFunctionResult<Data>;
